    ...
    <div className="min-h-screen bg-[#242424] text-white flex flex-col items-center py-8 px-4">
      <div className="w-full max-w-4xl">
        ...
        <p className="text-center mb-12 text-gray-300">
          How can we assist you today? Browse through the topics below to find answers to common questions.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ">
          <div className="bg-[#121212] p-6 rounded-lg cursor-pointer">
            ...
            <p className="text-gray-400">Manage your account settings and update your profile information.</p>
          </div>

          <div className="bg-[#121212] p-6 rounded-lg cursor-pointer">
            <h2 className="text-2xl font-semibold mb-4">Subscription & Payments</h2>
            <p className="text-gray-400">Get help with billing, payments, and subscription options.</p>
          </div>

          <div className="bg-[#121212] p-6 rounded-lg cursor-pointer">
            <h2 className="text-2xl font-semibold mb-4">Playlist Management</h2>
            <p className="text-gray-400">Learn how to create, edit, and share your playlists.</p>
          </div>

          <div className="bg-[#121212] p-6 rounded-lg cursor-pointer">
            <h2 className="text-2xl font-semibold mb-4">Technical Issues</h2>
            <p className="text-gray-400">Troubleshoot common technical problems and get technical support.</p>
          </div>

          <div className="bg-[#121212] p-6 rounded-lg cursor-pointer">
            <h2 className="text-2xl font-semibold mb-4">Privacy & Security</h2>
            <p className="text-gray-400">Understand how we protect your data and ensure your privacy.</p>
          </div>

          <div className="bg-[#121212] p-6 rounded-lg cursor-pointer">
            <h2 className="text-2xl font-semibold mb-4">Music & Content</h2>
            <p className="text-gray-400">Learn more about our music library and content policies.</p>
          </div>
        </div>
